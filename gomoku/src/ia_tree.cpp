...
ia_tree::ia_tree(Gomoku* gom)
{
 int i;
  ...
  this->p = this->Gom->p;
  this->cout = 0;
  this->c = (char **) malloc (HOR * sizeof (*this->c));
  for (i = 0; i < VER; i++)
      this->c[i] = (char *) malloc (VER * sizeof (*this->c[i]));
  /*for (int i = 0; i < VER; i++)
    for (int j = 0; j < HOR; j++)
...
void ia_tree::browse_board_test(ia_tree* tr)
{
     ...
     if (tr->counter <= PROFONDEUR_DEFAULT)
     {
           for (i = 0; i < VER; i++)
           {
               for (j = 0; j < HOR; j++)
               {   
                   if (is_playable(j, i, INTERVAL_DEFAULT) == true
                     ...
                     //        printf("Value modified 1\n");
                        ...
                        // << tr->x << " y = " << tr->y << std::endl;
                         ...
                         else
                          {
                              ...
                              if ((temp->counter) < PROFONDEUR_DEFAULT)
                              {
...
//     int cout_en_cours;
//     
//     if (this->counter <= PROFONDEUR_DEFAULT)
//     {
//           for (i = 0; i < VER; i++)
//           {
//               for (j = 0; j < HOR; j++)
